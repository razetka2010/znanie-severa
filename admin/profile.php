    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="Download Russian" class="nav-link">🚪 Выход</a></li>
            </ul>
        </nav>
    </aside>
                ...
                <div class="profile-section">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3>Всего входов</h3>
                                <span class="stat-number"><?php echo $activity_stats['total_logins']; ?></span>
                            </div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon">🕒</div>
